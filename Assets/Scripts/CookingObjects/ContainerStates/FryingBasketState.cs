...
public class FryingBasketState : IContainerState
{
    private GameObject[] ingredientModels000, ingredientModels002, ingredientModels010, ingredientModels012, ingredientModels100, ingredientModels102, ingredientModels110, ingredientModels112;
    ...
    public FryingBasketState(int containerID,
                             ...
                             GameObject[] ingredientModels010,
                             GameObject[] ingredientModels012,
                             GameObject[] ingredientModels100,
                             GameObject[] ingredientModels102,
                             GameObject[] ingredientModels110,
                             GameObject[] ingredientModels112,
                             int[] ingredientsIDs)
    {
        ...
        this.ingredientModels010 = ingredientModels010;
        this.ingredientModels012 = ingredientModels012;
        this.ingredientModels100 = ingredientModels100;
        this.ingredientModels102 = ingredientModels102;
        this.ingredientModels110 = ingredientModels110;
        this.ingredientModels112 = ingredientModels112;
                            ...
                            case 0:
                                switch (ingredientState3)
                                {
                                    case 0:
                                        ...
                                        break;
                                    case 2:
                                        ingredientModels002[containedItemIndex].SetActive(true);
                                        lastModel = ingredientModels002[containedItemIndex];
                                        break;
                                }
                                break;
                            case 1:
